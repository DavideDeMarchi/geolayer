...
BASE_URL = 'http://141.227.140.197/dts/redis'
...
def redisStore(text: str,
    ...
    req = requests.post('{}/'.format(BASE_URL), json={'text': text, 'expire': expire})
...
def redisGet(code: str):
    ...
    req = requests.get('{}/{}'.format(BASE_URL,code))
...
def redisDelete(code: str):
    ...
    req = requests.delete('{}/{}'.format(BASE_URL,code))
